...
class TimingFrameRx(pr.Device):
    def __init__(self, name="TimingFrameRx", description="Status of timing frame reception", memBase=None, offset=0x0, hidden=False):
        ...
        self.add(pr.Variable(   name         = "sofCount",
        ...
        self.add(pr.Variable(   name         = "eofCount",
        ...
        self.add(pr.Variable(   name         = "FidCount",
        ...
        self.add(pr.Variable(   name         = "CrcErrCount",
        ...
        self.add(pr.Variable(   name         = "RxClkCount",
        ...
        self.add(pr.Variable(   name         = "RxRstCount",
        ...
        self.add(pr.Variable(   name         = "RxDecErrCount",
        ...
        self.add(pr.Variable(   name         = "RxDspErrCount",
        ...
        self.add(pr.Variable(   name         = "RxCountReset",
        ...
        self.add(pr.Variable(   name         = "RxLinkUp",
        ...
        self.add(pr.Variable(   name         = "RxPolarity",
        ...
        self.add(pr.Variable(   name         = "RxReset",
        ...
        self.add(pr.Variable(   name         = "ClkSel",
        ...
        self.add(pr.Variable(   name         = "RxDown",
        ...
        self.add(pr.Variable(   name         = "BypassRst",
        ...
        self.add(pr.Variable(   name         = "MsgDelay",
        ...
        self.add(pr.Variable(   name         = "TxClkCount",
        ...
        self.add(pr.Variable(   name         = "BypassDoneCount",
        ...
        self.add(pr.Variable(   name         = "BypassResetCount",
        ...
        self.add(pr.Command (   name         = "C_RxReset",
        ...
        self.add(pr.Command (   name         = "ClearRxCounters",
